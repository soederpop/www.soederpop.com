...
Software development teams (loosely) follow the agile software development methodology, which assumes that a vision for a software project can be broken down into small, trackable units of work called Stories. Stories are things that can be estimated, prioritized, scheduled, started, stopped, and hopefully eventually completed.
